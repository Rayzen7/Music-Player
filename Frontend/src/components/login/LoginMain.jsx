...
<<<<<<< HEAD
            <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center w-[450px] h-[450px] bg-black bg-opacity-50 rounded-lg lg:scale-100 scale-[80%]">
=======
...
>>>>>>> 2cf9ac7b83e92fff8a5559ac60e329805e7ce3c9
                ...
                <div className={`message fixed top-4 left-1/2 transform -translate-x-1/2 bg-white text-black text-center p-2 rounded-lg transition-opacity duration-500 font-poppins ${message ? 'opacity-100' : 'opacity-0'}`}>
                    {message && <p>{message}</p>}
                </div>
